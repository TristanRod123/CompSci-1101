...
#Determine whether chracters in the answers needs to be guessed
for answer_chracter in answer:
  if re.search("^[A-Z]$",answer_chracter):
...
while num_of_incorrect_guesses < TOTAL_NUM_OF_INCORRECT_GUESSES_ALLOWED and False in answer_guessed:
  ...
  print(f"Number of incorrect guesses remianing: {TOTAL_NUM_OF_INCORRECT_GUESSES_ALLOWED - num_of_incorrect_guesses}")
